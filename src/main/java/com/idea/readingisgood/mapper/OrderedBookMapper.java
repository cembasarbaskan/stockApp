...
public class OrderedBookMapper implements BaseMapper<OrderedBookDTO, OrderedBook> {
    ...
    public OrderedBookDTO entityToDTO(OrderedBook entity) {
        return new OrderedBookDTO(entity.getId(), entity.getBook().getId(), entity.getOrder().getId(),
            entity.getPiece());
    }
    ...
    public OrderedBook dtoToEntity(OrderedBookDTO dto) {
        ...
        return new OrderedBook(dto.getId(), optionalBook.get(), optionalOrder.orElse(null), dto.getPiece());
    }
